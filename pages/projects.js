        ...
        <div className="flex flex-col  w-[80%] gap-4 min-h-1/2 text-dsfont xl:w-full ">
          <div className="border-b-2 border-gray-600 grid grid-cols-3 grid-rows-5 min-h-3/4 gap-x-4 p-4  mdlg:grid-rows-5 mdlg:grid-cols-1 mdlg:gap-y-4 sm:gap-y-2 sm:grid-rows-12">
            ...
            <div className=" col-span-2 row-span-2 sm:text-sm text-justify sm:row-span-3">
              This is a bootcamp (Binar Academy) project that i am involved in, the front-end was done using nextJS framework while the back-end was done using expressJS with postgresql as database. Most of my contribution is at the back-end and deployment, with some in the front-end especially the rock paper scissor game and redux. since the website is hosted on heroku it might takes time to load the website
            </div>
          ...
          <div className="border-b-2 border-gray-600 grid grid-cols-3 grid-rows-5 min-h-3/4 gap-x-4 p-4  mdlg:grid-rows-5 mdlg:grid-cols-1 mdlg:gap-y-4 sm:gap-y-2 sm:grid-rows-12">
            ...
            <div className=" col-span-2 row-span-1 sm:row-span-1">
              <h1 className="text-white text-4xl font-bold sm:text-3xl">Mock Project 1</h1>
            </div>
            <div className=" col-span-2 row-span-2 sm:text-sm text-justify sm:row-span-3">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, exercitationem veniam possimus fugit hic consequatur incidunt error sequi debitis quibusdam temporibus inventore vel quae soluta corporis perspiciatis libero. Sunt, ipsum quod! Blanditiis ratione architecto molestias, voluptatum corporis obcaecati sequi necessitatibus unde ab mollitia eius. Magni nemo natus eum necessitatibus repellendus!
            </div>
            <div className=" col-span-2 row-span-2 sm:row-span-4">
              <div className="grid grid-cols-1 grid-rows-5 h-full ">
                <div className=" row-span-3 grid grid-cols-1 text-sm mb-4  sm:row-span-4 sm:mb-1">
